...
public class Rainmaker
{
    ...
    public static final String MODID = "rainmaker";
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("rainmaker_tab", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup.rainmaker")) //The language key for the title of your CreativeModeTab
            .withTabsBefore(CreativeModeTabs.COMBAT)
            .icon(() -> SummonRainItem.get().getDefaultInstance())
    ...
    public Rainmaker(IEventBus modEventBus, ModContainer modContainer)
    {
